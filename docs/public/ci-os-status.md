...
| Deployed package | Verified | CI-OS commit `f8f8a3cfd5f39577ff224aabdc3c195e59ddc7a4` is deployed at `/opt/cios/app`; package contract passed as `cios`. |
